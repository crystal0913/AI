...
class PolicyGradient:
    def __init__(self,
        ...
        self.ep_obs, self.ep_as, self.ep_rs = [], [], []  # 状态、动作、奖励
    ...
    def _build_net(self):
        ...
        with tf.name_scope('loss'):
            ...
            neg_log_prob = tf.reduce_sum(
                -tf.log(self.all_act_prob) * tf.one_hot(indices=self.tf_acts, depth=self.n_actions), axis=1)
    ...
    # 计算折扣后的 reward
    # 当前状态s采取动作a所获得的真实奖励：应该是即时奖励加上未来直到episode结束的奖励和，但未来的奖励要打折扣
    # 公式： E = r1 + r2 * gamma + r3 * gamma^2 + r4 * gamma^3 ...
