...
dataset = torchvision.datasets.MNIST(root='../../MNIST_data/', train=True, transform=transform, download=True)
...
for epoch in range(total_epochs):
    ...
    for i, data in enumerate(dataloader):
        ...
        epoch, total_epochs, i, len(dataloader), d_loss.item(), g_loss.item()))
